...
namespace Bayetech.Core.Entity
{
    ...
    public partial class oasEntities : DbContext
    {
        ...
        public virtual IQueryable<fn_Str_Split_Result> fn_Str_Split(string @string, string separator)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_Str_Split_Result>("[oasEntities].[fn_Str_Split](@String, @Separator)", stringParameter, separatorParameter);
        }
        ...
        public virtual ObjectResult<SP_GetUserMenu_Result> SP_GetUserMenu(string mODULE_ID, string uSERID, string sysFlag, string iSDep)
        {
            var mODULE_IDParameter = mODULE_ID != null ?
                new ObjectParameter("MODULE_ID", mODULE_ID) :
                new ObjectParameter("MODULE_ID", typeof(string));
            ...
            var iSDepParameter = iSDep != null ?
                new ObjectParameter("ISDep", iSDep) :
                new ObjectParameter("ISDep", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GetUserMenu_Result>("SP_GetUserMenu", mODULE_IDParameter, uSERIDParameter, sysFlagParameter, iSDepParameter);
        }
