...
define(['jquery', 'common', 'Scripts/app/GoodPublish/TradeType'], function ($, common, TradeType) {
    var html=`<div class="one-step-con">
                  ...
                  <div class="refer-price">
                      <h2>今日成交价参考（广东区/广东1区 ）：<span>1 万金=<i class ="singlepr">{{percent}}</i>元(1元={{10000/percent}}) </span></h2>
                      <div class="publish-area">
                          <div class="gold-num">
                              <span><i>*</i>数量：</span>
                              <input maxlength="9" type="text" name="num" v-model="num" class ="common-input gdnum onlynum" datatype="howmany"><span>万金</span>
                          ...
                          <div class="case-num">
                              <span><i>*</i>想卖多少钱：</span>
                              <input maxlength="12" type="text" name="price" v-model="price" class ="common-input cenum onlynums" datatype="howmuch"><span>元 </span>{{price}}
                              <em>（可自行调整）</em>
                              <span class="Validform_checktip"></span>
                          </div>
                          <h3 class="htips"></h3>
                      ...
                      <div class="goods-title">
                          <h3>
                              ...
                              <input type="hidden" name="title" :value="'【'+dealway+'】'">
