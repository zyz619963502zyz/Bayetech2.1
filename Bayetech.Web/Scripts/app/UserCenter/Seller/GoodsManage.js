        ...
        <div class="col-md-9 col-lg-10">
            <div class ="panel panel-default">
				<div class ="panel-heading">
					<h5 class ="right-buy-title">商品管理 <span style="margin-left: 5px;font-style:italic;font:8px;">切换 </span>
                ...
                <!--搜索框组件的位置 end-->
                    <div class ="game-order-list">
                        ...
                        <div class="nave">
                            <ul id="nave">
                                <li @click ="GetStatusOrder(0)" class =""><a href="javascript:void(0)">全部</a></li>
                                <li @click ="GetStatusOrder(0)" class ="active"><a href="javascript:void(0)">出售中</a></li>
                                <li @click ="GetStatusOrder(0)" class =""><a href="javascript:void(0)">审核中</a></li>
                                <li @click ="GetStatusOrder(0)" class =""><a href="javascript:void(0)">已下架</a></li>
                            </ul>
                        </div>
                        <div class ="ddxq">
                            <ul>
