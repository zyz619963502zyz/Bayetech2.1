//模块之间的操作
var GoodListMoudule=['vue', 'jquery', 'common','v-header', 'v-nav', 'GoodList', "ScreenBox","nav-top"]
//alert(1);
require(GoodListMoudule, function (Vue, $, common, header, nav, goodlist, screenbox ,navt) {
        var vm = new Vue({
