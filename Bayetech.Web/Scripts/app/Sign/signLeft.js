...
define("SignLeftModule", jsconfig.baseArr, function (Vue, $, common) {
    //Api
    var _CreatAccountUrl = "/api/User/CreatAccount"; //创建账号
    var _CheckAccountUrl = "/api/User/CheckAccount"; //检查账号重复
    ...
    //                        </label>
    //                           <input ref="Iphone" v-model="value.Iphone" class ="comIpt loginUserIpt" maxlength="11" valid="false" ajaxvalidate="tel" />
    ...
    //                            <i class ="iptIconInner iconfont"></i>
    //                        </label>
    //                        <input  ref="GamePass" type="password" v-model="value.GamePass" class ="comIpt loginPwdIpt" valid="false" maxlength="20"/>
    ...
    //                            <i class ="iptIconInner iconfont"></i>
    //                        </label>
    //                        <input type="password"  ref="GamePassAgain" v-model="value.GamePassAgain" class ="comIpt loginPwdIpt" valid="false" data_cmp1="true" data_cmp2="password"/>
                    ...
                    <div class ="loginMain">
                        <div class ="comIptBox userIptBox">
                            <label for="" class ="comIptIcon IptIconLeft">
                               ...
                               <input ref="phone" v-model="value.phone" class ="comIpt loginUserIpt" maxlength="11" valid="false" ajaxvalidate="tel" />
                               <input ref="Name" v-model="value.Name" class ="comIpt loginUserIpt  hide" maxlength="11" valid="false" ajaxvalidate="tel" />
                            <label for="" class ="comIptIcon IptIconRight hide delIcon">
                                <i class ="iptIconInner iconfont"></i>
                            </label>
                            <em class ="regDesc hide">请输入您的手机号</em>
                        ...
                        <div class ="comIptBox">
                            ...
                            <input  ref="Password" type="password" v-model="value.Password" class ="comIpt loginPwdIpt" valid="false" maxlength="20"/>
                            <!--<p class ="placeholder">请输入密码</p>-->
                            <em class ="regDesc hide">密码由6-20位字符组成, 需同时包含字母和数字</em>
                        </div>
                        <div class ="comIptBox">
    ...
    var leftComponent = {//全局注册
        ...
        methods: {
            ...
            SubMitSign: function () {
                debugger;
                this.$props.value.Name = localStorage.getItem("nickname");
